...
from LED3 import led_controller  # Shared NeoPixel arbiter
...
# 2) Blind-spot configuration payload
LD2417_BLIND_SPOT_CONFIG = bytes([
    0xFD, 0xFC, 0xFB, 0xFA,  # frame head
    0x1C, 0x00,              # intra-frame data length
    0x71, 0x01,              # command word
    0x00, 0x00,              # ACK
    0x10, 0x27, 0x00, 0x00,  # maximum warning distance 0x2710 = 10000 = 100m
    0x00, 0x00, 0x00, 0x00,  # minimum warning speed (0 km/h)
    0x88, 0x13, 0x00, 0x00,  # 0~10m detection coefficient 0x1388 = 5000
    0x14, 0x05, 0x00, 0x00,  # 10~26m detection coefficient 0x0514 = 1300
    0x88, 0x13, 0x00, 0x00,  # 26~40m detection coefficient 0x0258 = 600
    0x88, 0x13, 0x00, 0x00,  # 40~100m detection coefficient
...
def apply_ld2417_blind_spot_config(ser):
    ...
    try:
        ...
        _send_and_log("LD2417_BLIND_SPOT_CONFIG", LD2417_BLIND_SPOT_CONFIG)
